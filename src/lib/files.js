import same_heart from "../asset/같은 마음이었으면.mp3";
import paper from "../asset/도화지.mp3";
...
import i_hate from "../asset/좋아해서 미워요.wav";
import gone_ever from "../asset/다시 오지 않을 날들.wav";
...
import i_hate_thumb from "../asset/좋아해서 미워요-Thumbnail.jpg";
import gone_ever_thumb from "../asset/다시 오지 않을 날들-Thumbnail.jpg";

export const aduioFiles = [
  {
    title: "다시 오지 않을 날들",
    url: gone_ever,
    thumb: gone_ever_thumb,
  },
  {
    title: "좋아해서 미워요",
    url: i_hate,
  ...
  },
  {
    title: "별에게",
    url: to_the_star,
    thumb: to_the_star_thumb,
    lyrics:
      "[Verse 1]\n끊어진 눈물이 흐르네\n그녀가 헤어지자 말했어\n별이 되지 못한 나의 노래가\n그게 이유가 되었데\n\n많은 기억이 쏟아지고\n비가 흐르는 날이면\n그녀가 좋아했던 나의 노래\n내 마음속으로 스며들어와\n\n[Chorus]\n떠나지 마, 내가 잘 지낸다 말해\n내 노래가 그녀에게 닿기를\n오늘 밤에 보이는 별처럼\n내 노래가 그녀에게 닿길\n말하고 싶어 나는 괜찮다고\n\n[Verse 2]\n긴 만큼 걸려 온 전화\n그녀의 전화번호 였어\n전화 속 음성은 그녀의 어머니\n내게 장례식에 왔으면 좋겠다고\n\n그녀의 비밀을 알게 됐어\n병으로 긴 시간 못 살았지만\n나만은 잘 지내기를 원했다고\n한 번이라도 좋으니 노래 듣고 싶었다고\n\n[Chorus]\n떠나지 마, 내가 잘지낸다 말해\n내 노래가 그녀에게 닿기를\n오늘 밤에 보이는 별처럼\n내 노래가 그녀에게 닿길\n말하고 싶어 나는 괜찮다고\n",
  },
  {
    title: "아마 그럴 거야",
    url: maybe,
